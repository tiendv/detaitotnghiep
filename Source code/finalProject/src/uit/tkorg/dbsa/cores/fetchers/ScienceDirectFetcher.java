...
public class ScienceDirectFetcher implements EntryFetcher {
	...
	/* (non-Javadoc)
	 * @see net.sf.jabref.imports.EntryFetcher#processQuery(java.lang.String, net.sf.jabref.imports.ImportInspector, net.sf.jabref.OutputPrinter)
	 */
	@Override
	public boolean processQuery(String arg0, ImportInspector arg1,
			OutputPrinter arg2) {
