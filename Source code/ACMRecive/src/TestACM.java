...
public class TestACM {
	...
	public boolean processQuery(String query ) { 
	        ...
	        try {
	        	...
	        	// Thuc hien cau truy van tra ve chuoi string 
	            ...
	            if (hits == 0) {
	               System.out.printf("Khong co ket qua tra ve");
	                return false;
	            }
	            // parse the result page and all following pages for article lay thong tin cua tac gia tu URL tra ve.
	            // urls
    ...
    public BibtexEntry fetchArticleBibtex(String urlToArticle)
        ...
        String entryID = biburl.substring(biburl.indexOf("?") + 1, biburl
            .indexOf("&"));
        // ?id=201740&ids=SERIES9630.201740&types=series.nondiv_book&reqtype=nondiv_book&coll=Portal&dl=Portal&CFID=101938677&CFTOKEN=29249970
    ...
    public static String hasFollowingPage(String hitlist) {
        Pattern p = Pattern.compile("<a href=\"results\\.cfm\\?query=(.+?)\">(\\s*)next(\\s*)</a>");
